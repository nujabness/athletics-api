...
class UserController {
    ...
    static async update(request, response) {
        ...
        try {
            ...
            await User.update({_id: id}, request.body);
            let user = await User.findOne({_id: id}).populate('nationalite_athlete');
    ...
    static async register(request, response) {
        ...
        let body = {};
        try {
            let nationalite = await Nationalite.findOne({nom_nationalite: 'FRANCE'});
